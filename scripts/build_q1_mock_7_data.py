...
ETYMOLOGY = {
    "mediocre": "ラテン語 mediocris（中間の）から。中くらいで目立たない状態を表す。",
    "sluggish": "slug（のろい人、怠け者）に由来し、動きの鈍さを表す。",
    "peevish": "中英語 pevishe（愚かな、気難しい）から、いら立ちやすい性質を表す。",
    "deferential": "ラテン語 deferre（下へ運ぶ、譲る）から。相手にへりくだる態度を表す。",
    "infer": "ラテン語 inferre（中へ運ぶ）から、事実から結論を導く意味になった。",
    "chisel": "古フランス語 chisel（のみ）から。のみで削る動作を表す。",
    "douse": "中英語 dousen（打ちつける、消す）にさかのぼる動詞。",
    "dilute": "ラテン語 diluere（洗い流す）から。液体などを薄める意味になった。",
    "facet": "フランス語 facette（小さな面）から、全体の一面を表す。",
    "tantrum": "17世紀英語の語で、突然の癇癪を表す語として定着した。",
    "conundrum": "17世紀英語の謎語から生じた語で、難しい問題を表す。",
    "cohort": "ラテン語 cohors（囲い、隊）から、まとまりを持つ集団を表す。",
    "trepidation": "ラテン語 trepidare（震える）から、恐怖で身震いする状態を表す。",
    "condemnation": "ラテン語 condemnare（有罪と宣告する）から、強い非難を表す。",
    "decimation": "ラテン語 decimare（10分の1を取る）から、後に大きな損失や激減を表す。",
    "destitution": "ラテン語 destituere（見捨てる）から、支えを失った困窮を表す。",
    "squandered": "squander（浪費する）は、資源を無造作に散らす意味から浪費を表す。",
    "kindled": "古ノルド語 kynda（火を燃やす）と関連し、火や感情を燃え立たせる。",
    "ascended": "ラテン語 ascendere（上へ登る）から、上昇や昇進を表す。",
    "cuddled": "cuddle は16世紀以降の英語で、体を寄せて抱く動作を表す。",
    "derided": "ラテン語 deridere（あざ笑う）から、人をばかにする意味になった。",
    "brewed": "古英語 breowan（煮る、醸造する）から、問題が生じる意味にも広がった。",
    "abridged": "ラテン語 brevis（短い）に由来し、長いものを短くする意味を表す。",
    "embittered": "em-（中へ、状態にする）＋bitter（苦い）から、苦々しい思いにする。",
    "insubordinate": "ラテン語 in-（反対）＋subordinare（下位に置く）から、服従しないことを表す。",
    "reclusive": "ラテン語 recludere（閉じ込める）から、世間から閉じこもる状態を表す。",
    "virtuous": "ラテン語 virtus（徳、力）から、道徳的に優れた性質を表す。",
    "steadfast": "古英語 stede（場所、立場）＋fæst（固い）から、立場を変えないことを表す。",
    "inexorably": "ラテン語 inexorabilis（説得できない）から、止められない様子を表す。",
    "genially": "ラテン語 genialis（祝祭や生まれに関する）から、明るく親しげな様子を表す。",
    "spuriously": "ラテン語 spurius（正当でない、偽の）から、偽物のような状態を表す。",
    "exquisitely": "ラテン語 exquirere（詳しく探し出す）から、非常に精妙な状態を表す。",
    "incision": "ラテン語 incidere（中へ切り込む）から、切開や切り込みを表す。",
    "renunciation": "ラテン語 renuntiare（返して告げる、放棄する）から。",
    "abrasion": "ラテン語 abradere（こすり取る）から、擦り傷や摩耗を表す。",
    "combustion": "ラテン語 comburere（完全に焼く）から、燃焼を表す。",
    "interjected": "ラテン語 intericere（間に投げ入れる）から、会話に割って入る意味になった。",
    "attuned": "tune（調子）に at- が加わり、調子を合わせた状態を表す。",
    "eclipsed": "ギリシャ語 ekleipsis（消失）から、光や成功を覆い隠す意味になった。",
    "despised": "ラテン語 despicere（見下ろす）から、軽蔑する意味になった。",
    "contemplative": "ラテン語 contemplari（観察する、熟考する）から、深く考える性質を表す。",
    "scrawny": "英語 scrawny は、皮膚と骨ばかりのようにやせた状態を表す語として定着した。",
    "eminent": "ラテン語 eminere（突き出ている）から、目立って優れた状態を表す。",
    "squalid": "ラテン語 squalere（ざらざらして汚れている）から、不潔な状態を表す。",
    "trysts": "中英語 tryst（取り決めた場所・時）から、恋人同士の密会を表す。",
    "rebuttals": "ラテン語 re-（再び、反対に）＋battuere（打つ）から、反論を表す。",
    "denominations": "ラテン語 denominare（名前を付ける）から、分類名や額面を表す。",
    "violations": "ラテン語 violare（乱暴に扱う、破る）から、規則を破る行為を表す。",
    "scandalous": "ギリシャ語 skandalon（わな、つまずき）から、世間を騒がせるものを表す。",
    "latent": "ラテン語 latere（隠れている）から、まだ表に出ていない状態を表す。",
    "reminiscent": "ラテン語 reminisci（思い出す）から、何かを思い起こさせることを表す。",
    "prudish": "prude（堅苦しく潔癖な人）から、過度に慎み深い性質を表す。",
    "eloquent": "ラテン語 eloqui（外へ語る）から、表現力豊かに話すことを表す。",
    "discernible": "ラテン語 discernere（分けて見分ける）から、識別できる状態を表す。",
    "cryptic": "ギリシャ語 kryptos（隠された）から、謎めいて分かりにくい状態を表す。",
    "jubilant": "ラテン語 jubilare（喜びの声を上げる）から、歓喜に満ちた状態を表す。",
    "mutiny": "フランス語 mutin（反抗的な）から、船員などの反乱を表す。",
    "divergence": "ラテン語 divergere（別々の方向へ向かう）から、分岐や相違を表す。",
    "expletive": "ラテン語 explere（満たす）から、感情を満たす発話や罵り言葉を表す。",
    "frivolity": "ラテン語 frivolus（もろい、価値のない）から、軽薄で実のない態度を表す。",
    "unscathed": "un-（ない）＋古ノルド語 skaði（害、損傷）から、傷ついていない状態を表す。",
    "unfounded": "un-（ない）＋found（根拠を置く）から、根拠が置かれていない状態を表す。",
    "concerted": "ラテン語 concertare（協力して争う、調和させる）から、協調した状態を表す。",
    "outmoded": "out-（外へ、超えて）＋mode（流行、方式）から、流行遅れの状態を表す。",
    "obfuscating": "ラテン語 obfuscare（暗くする）から、意味を曖昧にすることを表す。",
    "hibernating": "ラテン語 hibernare（冬を過ごす）から、冬眠することを表す。",
    "pontificating": "pontifex（高位の聖職者）から、権威ぶって話す意味に広がった。",
    "reverberating": "ラテン語 reverberare（打ち返す）から、音が反響することを表す。",
    "panders": "ギリシャ神話の Pandarus に由来し、相手に取り入る仲介者を表した。",
    "flinches": "古フランス語 flenchir（身を引く）に関係し、恐れなどでひるむ動作を表す。",
    "jangles": "古フランス語 jangler（無駄話をする、騒がしく鳴らす）から。",
    "abstains": "ラテン語 abstinere（離して保つ）から、控える意味になった。",
    "impunity": "ラテン語 impunitas（罰がないこと）から、処罰を受けない状態を表す。",
    "slumber": "中英語 slumer（眠る）から、眠りや活動停止を表す。",
    "temerity": "ラテン語 temeritas（無謀さ）から、向こう見ずな大胆さを表す。",
    "attire": "古フランス語 atirer（整える、身につけさせる）から、服装を表す。",
    "nemesis": "ギリシャ神話の Nemesis（報復の女神）から、かなわない宿敵を表す。",
    "glutton": "古フランス語 gloton（大食漢）から、大量に食べる人を表す。",
    "paragon": "イタリア語 paragone（比較、試金石）から、比較の模範を表す。",
    "protégé": "フランス語 protégé（保護された人）から、後援を受ける人を表す。",
    "confounded": "ラテン語 confundere（混ぜ合わせる）から、混乱させる意味になった。",
    "relocated": "ラテン語 relocare（再び置く）から、別の場所へ移す意味を表す。",
    "pillaged": "フランス語 piller（略奪する）から、財物を奪う意味になった。",
    "extradited": "ラテン語 extra（外へ）＋tradere（引き渡す）から、国外へ引き渡す意味を表す。",
    "roll over": "roll（転がる）＋over（境目を越えて）から、残高などを次へ繰り越す。",
    "thin out": "thin（薄くする）＋out（外へ取り除いて）から、密度を下げて間引く。",
    "square up": "square（整える）＋up（整った状態まで）から、帳尻を合わせて精算する。",
    "wind down": "wind（巻く、動かす）＋down（勢いや量を下げて）から、徐々に終える。",
    "hemmed in": "hem（縁取りで囲う）＋in（内側へ）から、周囲を囲んで閉じ込める。",
    "glossed over": "gloss（表面を飾る）＋over（上から覆う）から、問題を表面だけ覆って軽く扱う。",
    "bailed out": "bail（保釈金で助ける）＋out（外へ出す）から、困難な状況から救い出す。",
    "polished off": "polish（磨いて仕上げる）＋off（離れた状態まで）から、残りをすっかり処理する。",
    "muscle in on": "muscle（力で押し入る）＋in（中へ）＋on（対象に向けて）から、相手の領域に割り込む。",
    "stock up on": "stock（蓄える）＋up（いっぱいに整える）＋on（対象に向けて）から、対象を買い込む。",
    "tie in with": "tie（結びつける）＋in（内側へ）＋with（一緒に）から、別のものと関連づける。",
    "clamp down on": "clamp（締め具で固定する）＋down（押さえつけて）＋on（対象に向けて）から、厳しく取り締まる。",
    "struck on": "strike（打つ、ふと出会う）＋on（対象に触れて）から、考えにふと行き当たる。",
    "pushed for": "push（押す）＋for（目的へ向けて）から、実現を強く求める。",
    "hailed from": "hail（呼びかける、出身である）＋from（起点から）から、出身地を表す。",
    "set forth": "set（置く）＋forth（前へ）から、考えを前へ出して提示する。",
}
