...
DATA_DIR = ROOT / "data"
DATASET_ID = "eiken1-mock-7"
QUESTIONS_PATH = DATA_DIR / "questions_1_mock-7.json"
VOCAB_PATH = DATA_DIR / "vocab_1_mock-7.json"
LEMMA_PATH = DATA_DIR / "lemmas.json"
ORIGINS_PATH = DATA_DIR / "word_origins.json"
EXCLUDED_PATH = DATA_DIR / "word_origin_excluded.json"
AUDIO_DIR = ROOT / "assets" / "audio" / "vocab" / "1" / "mock-7"
