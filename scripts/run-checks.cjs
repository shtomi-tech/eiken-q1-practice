...
const CHECKS = [
  ...
  ["scripts/check-context-sense.cjs"],
  ["scripts/check-context-pos-prefilter.cjs"],
  ["scripts/check-json-duplicate-keys.cjs"],
  ["scripts/check-context-batch-q6-q7.cjs"],
  ["scripts/check-context-batch-q8-q9.cjs"],
