...
ETYMOLOGY = {
    "billowing": "billow（大きく膨らんで波打つ）＋-ing。",
    "wrangling": "wrangle（口論する、交渉する）＋-ing。",
    "embarking": "embark（船に乗せる→新しいことに乗り出す）＋-ing。",
    "rambling": "ramble（とりとめなく話す、歩く）＋-ing。",
    "predilection": "pre-（前もって）＋dilect（選ぶ）に由来し、先に選び取る好み。",
    "depreciation": "depreciate（価値を下げる）＋-ion。",
    "countenance": "ラテン語系の語で、もとは顔つき・表情を指す名詞。",
    "resurgence": "re-（再び）＋surge（波のように盛り上がる）＋-ence。",
    "accelerate": "ラテン語 accelerare（速める）に由来。",
    "soothe": "古英語 sōþian（安心させる）に由来。",
    "mumble": "mumble（不明瞭に発する）という反復音から生じた語。",
    "dodge": "中英語 doggen（急に身をかわす）に由来。",
    "distended": "ラテン語 distendere（広げる）から、dis-（離して）＋tend（伸ばす）。",
    "blared": "blare（大きく鳴る）＋過去形 -ed。",
    "perused": "ラテン語 per（完全に）＋use（使う）から、隅々まで読む意へ。",
    "savored": "savor（味・風味を味わう）＋過去形 -ed。",
    "contours": "フランス語 contour（周囲の線）＋複数形 -s。",
    "epitaphs": "ギリシャ語 epi（上に）＋taphos（墓）から、墓に刻む文。",
    "strata": "ラテン語 stratum（層）の複数形。",
    "amalgams": "amalgam（混ぜ合わせたもの）＋複数形 -s。",
    "uncouth": "un-（〜でない）＋couth（洗練された）。",
    "decorous": "ラテン語 decorus（ふさわしい、上品な）に由来。",
    "insular": "ラテン語 insula（島）＋-ar。",
    "methodical": "ギリシャ語 methodos（追究の道筋）＋-ical。",
    "mechanically": "mechanical（機械的な）＋副詞語尾 -ly。",
    "lethally": "lethal（死をもたらす）＋副詞語尾 -ly。",
    "ruefully": "rue（後悔する）＋-ful＋副詞語尾 -ly。",
    "coarsely": "coarse（粗い、粗野な）＋副詞語尾 -ly。",
    "kindred": "kin（血縁）と同系で、同種・共通点のある意へ。",
    "germane": "古英語系で、もともと同じ血筋・関係のある意。",
    "seditious": "ラテン語 seditio（反乱）＋-ous。",
    "laudable": "ラテン語 laudare（ほめる）＋-able。",
    "emulation": "ラテン語 aemulari（競い合う、まねる）＋-tion。",
    "premonition": "pre-（前もって）＋monition（警告）から、前触れの知らせ。",
    "naturalization": "naturalize（国民として認める）＋-ation。",
    "persecution": "ラテン語 persequi（追い続ける）＋-tion。",
    "fortifying": "fortify（強くする）＋-ing。fort（要塞）と同系。",
    "amassing": "amass（大量に集める）＋-ing。",
    "bestowing": "bestow（与える、授ける）＋-ing。",
    "pestering": "pester（しつこく悩ませる）＋-ing。",
    "shelved": "shelf（棚）＋-ed。棚に置くことから保留する意へ。",
    "neglected": "ラテン語 neglegere（疎かにする）＋-ed。",
    "sharpened": "sharp（鋭い）＋-en＋-ed。",
    "evicted": "ラテン語 evincere（追い出す）系の evict＋-ed。",
    "obscure": "ラテン語 obscurus（暗い、覆われた）に由来。",
    "insatiable": "in-（〜でない）＋satiate（満たす）＋-able。",
    "urbane": "ラテン語 urbanus（都市の、洗練された）に由来。",
    "entrenched": "entrench（塹壕に入れる）＋-ed。根深く固定する比喩へ。",
    "indemnity": "ラテン語 indemnis（損害を受けていない）＋-ity。",
    "anomaly": "ギリシャ語 an-（〜でない）＋homalos（均一な）から、標準外。",
    "epoch": "ギリシャ語 epokhē（停止、区切り）に由来。",
    "amnesty": "ギリシャ語 amnēstia（忘却）に由来。",
    "celebrate": "ラテン語 celebrare（大勢で集う、称える）に由来。",
    "curtail": "古フランス語 court（短い）系で、短く切る意。",
    "chastise": "ラテン語 castigare（正す、罰する）に由来。",
    "perambulate": "ラテン語 per（通って）＋ambulare（歩く）。",
    "deference": "ラテン語 deferre（運ぶ、譲る）から、相手に譲る敬意。",
    "ardor": "ラテン語 ardor（熱、燃焼）に由来。",
    "acuity": "ラテン語 acutus（鋭い）＋-ity。",
    "candor": "ラテン語 candor（白さ、率直さ）に由来。",
    "chauvinism": "フランス語の固有名に由来する -ism で、盲目的な忠誠・優越意識。",
    "austerity": "ギリシャ語 austeros（厳しい、乾いた）に由来。",
    "derision": "ラテン語 deridere（あざ笑う）＋-ion。",
    "arrogance": "ラテン語 arrogare（自分のものだと要求する）＋-ance。",
    "arbitrary": "ラテン語 arbiter（判断者）から、個人の判断に基づく意へ。",
    "makeshift": "make（作る）＋shift（間に合わせ）から、急場しのぎ。",
    "presumptuous": "ラテン語 praesumere（先に取る、思い込む）＋-ous。",
    "sagacious": "ラテン語 sagax（洞察力のある）＋-ious。",
    "allayed": "allay（和らげる、静める）＋-ed。",
    "hatched": "hatch（卵からかえす→計画を孵化させる）＋-ed。",
    "deformed": "de-（形を損なって）＋form（形）＋-ed。",
    "sapped": "sap（樹液→活力を奪う）＋-ed。",
    "waiver": "waive（放棄する）＋-er。",
    "fortress": "fort（要塞）＋-ress。",
    "faculty": "ラテン語 facultas（能力、機能）に由来。",
    "dissension": "ラテン語 dissentire（意見が異なる）＋-ion。",
    "gregarious": "ラテン語 gregarius（群れに属する）に由来。",
    "insouciant": "フランス語 in-（〜でない）＋souci（心配）＋-ant。",
    "sullen": "中英語 sullen（陰気な）に由来。",
    "nomadic": "ギリシャ語 nomas（牧草地を移動する）＋-ic。",
    "robust": "ラテン語 robustus（樫のように強い）に由来。",
    "frail": "古フランス語 fraile（弱い、もろい）に由来。",
    "marginal": "margin（縁、限界）＋-al。",
    "ferocious": "ラテン語 ferox（野性の、激しい）＋-ious。",
    "shy away from": "shy（尻込みする）＋away（離れる方向）＋from（対象）。",
    "rub off on": "rub（こする）＋off（表面から離して）＋on（次の対象へ）。",
    "turn off": "turn（向きを変える）＋off（切り離す）。",
    "make off with": "make（動かす）＋off（離れた方へ）＋with（伴って）。",
    "hang around": "hang（ぶら下がる）＋around（周囲に）。",
    "wait around": "wait（待つ）＋around（周囲に）。",
    "poke around": "poke（つつく）＋around（周囲を）。",
    "come clean": "come（来る）＋clean（隠し事のない状態）から、白状する慣用表現。",
    "reckoned on": "reckon（計算する）＋on（前提として）。",
    "rooted for": "root（根を張る）＋for（〜を支持して）から、応援する慣用表現。",
    "dashed down": "dash（勢いよく走る）＋down（下へ）。",
    "threw away": "throw（投げる）＋away（離れた方へ）。",
    "float around": "float（浮かぶ）＋around（周囲に）。",
    "weigh in": "weigh（重さを測る）＋in（中へ）。",
    "stack up": "stack（積み重ねる）＋up（上へ）。",
    "squeak by": "squeak（きしむ音を立てる）＋by（そばを通り抜けて）。",
}
