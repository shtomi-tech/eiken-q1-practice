...
DETAILS = {
    ...
    "banish": ("追放する", "動詞", "The ruler decided to banish the traitor from the kingdom.", "支配者は裏切り者を王国から追放することにした。"),
    "procure": ("調達する", "動詞", "The hospital had to procure extra supplies before the storm.", "病院は嵐の前に追加の物資を調達しなければならなかった。"),
    "stump": ("困らせる、困惑させる", "動詞", "The unexpected question may stump the spokesperson during the live interview.", "生放送のインタビュー中、予想外の質問が広報担当者を困らせるかもしれない。"),
    ...
    "exasperate": ("いらだたせる", "動詞", "Constant delays can exasperate passengers waiting at the crowded airport.", "度重なる遅れは、混雑した空港で待つ乗客たちをいらだたせることがある。"),
    "shun": ("避ける、遠ざける", "動詞", "The community chose to shun the dishonest trader.", "その地域社会は不正直な商人を避けることにした。"),
    "enchant": ("魅了する", "動詞", "The old castle can enchant visitors with its mysterious atmosphere.", "その古城は神秘的な雰囲気で訪問者を魅了することがある。"),
