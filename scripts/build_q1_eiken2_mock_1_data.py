...
DETAILS = {
    ...
    "have": ("持っている、〜する", "動詞", "I have enough time to finish the assignment before dinner tonight.", "私は今夜の夕食前に課題を終える時間が十分にある。"),
    "had": ("持っていた、〜した", "動詞", "She had an old map in her backpack during the hike.", "彼女はハイキング中、リュックに古い地図を持っていた。"),
