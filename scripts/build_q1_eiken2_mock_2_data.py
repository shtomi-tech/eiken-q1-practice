...
from lib.set_builders import run_eiken2_mock
...
QUESTIONS = [
    ...
    },
    {
        ...
        "choices": ["do you require", "should you require", "did you require", "you required"],
        "answerIndex": 1,
...
DETAILS = {
    ...
    "has taught": ("教えてきた、教えたことがある", "動詞句", "He has taught science at this university since the new building opened.", "彼は新しい建物が開いて以来、この大学で科学を教えてきた。"),
    ...
    "do you require": ("あなたは必要としますか", "動詞句", "The manager asked, Do you require any additional equipment for the event?", "マネージャーは、行事に追加の用具が必要かと尋ねた。"),
    ...
    "did you require": ("あなたは〜を必要としましたか", "動詞句", "The clerk asked, Did you require a receipt for the purchase?", "店員は、その購入について領収書を必要としたか尋ねた。"),
    "you required": ("あなたが必要とした", "動詞句", "The form records which documents you required for the application.", "その用紙には申請に必要とした書類が記録されている。"),
...
CORE_IMAGES = {
    ...
    "do you require": {"chain": [{"term": "do", "gloss": "現在の疑問を作って"}, {"term": "require", "gloss": "必要とする"}, {"gloss": "必要としますかと尋ねる"}]},
...
if __name__ == "__main__":
    run_eiken2_mock(ROUND_ID, QUESTIONS, DETAILS, CORE_IMAGES, IDIOM_QUESTIONS)
