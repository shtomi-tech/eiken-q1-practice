"""英検2級 Chapter 3 模擬テスト第4回の内容と重複を検証する。"""
...
DATA_DIR = ROOT / "data"
VOCAB_PATH = DATA_DIR / "vocab_2_mock-4.json"
QUESTIONS_PATH = DATA_DIR / "questions_2_mock-4.json"
DATASET_ID = "eiken2-mock-4"
...
def check() -> None:
    ...
    if answer_distribution != [4, 4, 6, 6]:
