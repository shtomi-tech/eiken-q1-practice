...
同じカードには、日別目標を1日4語句として、7・30・90・180・365日後の理論上の学習語句数と、準1級までの9,000語を起点に14,000語へ到達する予想日を表示します。いずれも学習ペースの目安であり、長期予測には現在の収録語句数を超える理論値が含まれます。
...
語源データは段階5バッチ5終了時点で語根108個、A型228語、B型40語を収録しています。全語をカバーする機能ではなく、語根から中心義を思い出せる語に限定しています。
