...
> ベース: [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) の Claude DESIGN.md（Anthropic公式サイト風の暖色エディトリアルデザイン）を本アプリ（英検5級・1級・2級・準2級・準1級の大問1語彙演習、Windows/モバイル環境）向けに適応。
